export function asideMenu(role, name, lastName) {
  return `<div class="dashboard__logo-container">
      ...
      <nav class="dashboard__nav">
        ...
        <a class="dashboard__a" href="#newTask"><button class="dashboard__nav-button" id="newTaskBtn">✍🏼 Nueva task</button></a>
        <a class="dashboard__a" href="#newEvent"><button class="dashboard__nav-button" id="newEventBtn">📆 Nuevo evento</button></a>`
            : ""
        }
